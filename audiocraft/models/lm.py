...
class LMModel(StreamingModule):
    ...
    def _sample_next_token(
        ...
        if use_sampling and temp > 0.0:
            ...
            if top_k < 0.0:
                next_token = utils.negative_sample_top_k(probs, k=-top_k)
                # print(f"We're in the negative K zone.")
            elif top_p < 0.0:
                next_token = utils.negative_sample_top_p(probs, p=-top_p)
                # print(f"We're in the negative P zone.")
            elif top_p > 0.0:
